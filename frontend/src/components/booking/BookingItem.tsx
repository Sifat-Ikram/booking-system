...
const BookingItem: React.FC<BookingItemProps> = ({ booking }) => {
  ...
  return (
    <motion.li
      ...
      className={`flex flex-col sm:flex-row justify-between items-start sm:items-center border rounded-lg p-5 shadow-md hover:shadow-xl transition-shadow duration-300 mb-4 ${
        status === "Ongoing"
